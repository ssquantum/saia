...
class image_handler:
    ...
    def add_count(self, im_name):
        ...
        if self.roi_size > 0:
            ...
            self.im_vals = np.loadtxt(im_name, delimiter=' ',usecols=range(1,65)) # hard coded in image size temporarily
...
class main_window(QMainWindow):
    ...
    def initUI(self):
        ...
        # im_grid_pos = 10 # x grid position. leave enought space for the histogram
        # # centre of ROI x position
        # xc_label = QLabel('ROI x_c: ', self)
        # grid.addWidget(xc_label, 0,im_grid_pos, 1,1)
        # self.roi_x_edit = QLineEdit(self)
        # grid.addWidget(self.roi_x_edit, 0,im_grid_pos+1, 1,1)
        ...
        # grid.addWidget(yc_label, 0,im_grid_pos+2, 1,1)
        # self.roi_y_edit = QLineEdit(self)
        # grid.addWidget(self.roi_y_edit, 0,im_grid_pos+3, 1,1)
        ...
        # grid.addWidget(l_label, 0,im_grid_pos+4, 1,1)
        # self.roi_l_edit = QLineEdit(self)
        # grid.addWidget(self.roi_l_edit, 0,im_grid_pos+5, 1,1)
        ...
        # grid.addWidget(self.im_show_toggle, 0,im_grid_pos+6, 1,1)
        # 
